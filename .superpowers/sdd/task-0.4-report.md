...
- `C:\path\to\wyrhta\Heorth\src\app.ts`
- `C:\path\to\wyrhta\Heorth\src\routes\health.ts`
- `C:\path\to\wyrhta\Heorth\src\modules\registry.ts`
- `C:\path\to\wyrhta\Heorth\tests\health.test.ts`
